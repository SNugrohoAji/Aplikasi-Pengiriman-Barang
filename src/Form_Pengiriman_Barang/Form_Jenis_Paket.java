...
private void tampildata(String sql) {
   ...
   datalist.addColumn("No");
    ...
    try {
        ...
        rspaket=st.executeQuery("select * from jenis_paket");
        while (rspaket.next()) {
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            sql = "update jenis_paket set paket_type='"+type+"',"+ "asuransi='"+asuransi+"',"+"biaya='"+biaya+"' where id_paket='"+id+"'";
            st=con.createStatement();
            st.execute(sql);
            tampildata("select * from jenis_paket");
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        {
            try {
                sql="delete from jenis_paket where id_paket='"+id+"'";
                st=con.createStatement();
                st.execute(sql);
                tampildata("select * from jenis_paket");
                JOptionPane.showMessageDialog(null, "data berhasil disimpan");
    ...
    public static void main(String args[]) {
      ...
      Form_Jenis_Paket frame = new Form_Jenis_Paket();
