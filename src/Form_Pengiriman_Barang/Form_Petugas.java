...
private void tampildata(String sql) {
   ...
   datalist.addColumn("No");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtjabatan, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(6, 6, 6)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            sql = "insert into petugas(id_petugas,nama_petugas,tugas,alamat,telepon)value ("
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            sql = "update petugas set nama_petugas='" + nama + "',"
                    + "tugas='"+jabatan+"',alamat='"+alamat+"',telepon='"+telepon+"' where id_petugas='"+id+"'";
            st=con.createStatement();
            st.execute(sql);
            tampildata("select * from petugas");
    ...
    private void gridpetugasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gridpetugasMouseClicked
        ...
        txtjabatan.setText(String.valueOf(gridpetugas.getValueAt(gridpetugas.getSelectedRow(),3)));
    ...
    public static void main(String args[]) {
      ...
      Form_Petugas frame = new Form_Petugas();
