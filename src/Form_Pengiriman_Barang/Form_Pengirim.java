...
private void tampildata(String sql) {
   ...
   datalist.addColumn("No");
    ...
    try {
        ...
        rspengirim=st.executeQuery("select * from pengirim");
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            sql = "insert into pengirim(no_pengirim,nama_pengirim,alamat,kota,provinsi,kodepos,daerah,telepon)value ("
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            sql = "update pengirim set nama_pengirim='" + nama + "',"
                    + "kota='"+kota+"',alamat='"+alamat+"',telepon='"+telepon+"',kodepos='"+kodepos+"',daerah='"+daerah+"',provinsi='"+provinsi+"' where no_pengirim='"+no+"'";
            st=con.createStatement();
            st.execute(sql);
            tampildata("select * from pengirim");
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        {
            try {
                sql="delete from pengirim where no_pengirim='"+no+"'";
                st=con.createStatement();
                st.execute(sql);
                tampildata("select * from pengirim");
                JOptionPane.showMessageDialog(null, "data berhasil disimpan");
    ...
    public static void main(String args[]) {
      ...
      Form_Pengirim frame = new Form_Pengirim();
